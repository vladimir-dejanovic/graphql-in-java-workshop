...
@Repository
public interface AttendeeConfSessionRepository extends JpaRepository<AttendeeConfSession,Long> {
    public List<AttendeeConfSession> findAttendeeConfSessionByAttendeeId(Long id);
}
